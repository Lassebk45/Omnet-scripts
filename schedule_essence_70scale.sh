...
experiment_name="demandscaleseventy"
...
TOPO_DIR="experiments/small-medium/"
...
# RUN SIMULATIONS
declare -a ALGS=("essence_stateless" "essence_big_flows" "essence" "shortest_path" "split_shortest_path") 
